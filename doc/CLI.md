...
npx paperclipai company purge <selector...> [--apply --yes --confirm <value>]
```
...
npx paperclipai company purge "cs development"

# Purge several companies as one set.
npx paperclipai company purge "cs consulting" "cs development" "cs website"

# Commit. Requires all three flags.
npx paperclipai company purge CSD --apply --yes --confirm CSD
```
